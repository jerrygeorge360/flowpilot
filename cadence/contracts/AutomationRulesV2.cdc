access(all) contract AutomationRulesV2 {
    ...
    access(all) resource RuleBook: RuleBookPublic {
        ...
        access(all) fun deactivateRule(index: Int) {
            pre {
                ...
                self.rules[index].schedulerId != nil: "Cannot deactivate rule without scheduler ID"
            }
    ...
    init() {
        self.RuleBookStoragePath = /storage/flowPilotRuleBookV2
        self.RuleBookPublicPath = /public/flowPilotRuleBookV2
    }
}
