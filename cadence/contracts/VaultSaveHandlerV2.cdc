...
access(all) contract VaultSaveHandlerV2 {
    ...
    access(all) struct SaveData {
        ...
        access(all) let ruleBookCap: Capability<&{AutomationRulesV2.RuleBookPublic}>
        ...
        init(
            ...
            ruleBookCap: Capability<&{AutomationRulesV2.RuleBookPublic}>,
        ...
        access(all) fun resolveView(_ view: Type): AnyStruct? {
            switch view {
                case Type<StoragePath>():
                    return /storage/VaultSaveHandlerV2
                case Type<PublicPath>():
                    return /public/VaultSaveHandlerV2
                default:
                    return nil
            }
        }
